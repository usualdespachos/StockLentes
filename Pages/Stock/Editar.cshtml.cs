...
public class EditarModel(StockDbContext db,InventoryService inventory):PageModel{
 ...
 public async Task<IActionResult> OnPostAsync(){
  ...
  try{await inventory.SaveAsync(Input.Id,Input.ProductId,Input.Sphere,Input.Cylinder,Input.Add,Input.Base,Input.Pairs,Input.Reason,Input.Version,Input.OperationKey);TempData["Success"]="Stock guardado y movimiento registrado.";return RedirectToPage("Index");}
